...
def save_to_pdf(data):
    ...
    font_path = "C:\\Users\\User\\Downloads\\Python\\Test\\Mitr\\Mitr-SemiBold.ttf"  # Provide the correct path to your .ttf file
...
def save_to_pdf2(data):
    ...
    # Register the custom TTF font
    font_path = "C:\\Users\\User\\Downloads\\Python\\Test\\Mitr\\Mitr-SemiBold.ttf"
...
def main():
    ...
    st.sidebar.image("C:\\Users\\User\\Downloads\\Python\\Test\\Image samples\\Sticker.png", use_column_width=True)
    ...
    st.sidebar.image("C:\\Users\\User\\Downloads\\Python\\Test\\Image samples\\Qr + Sticker.png", use_column_width=True)
    ...
    st.sidebar.image("C:\\Users\\User\\Downloads\\Python\\Test\\Image samples\\Qr.png", use_column_width=True)
    ...
    st.sidebar.image("C:\\Users\\User\\Downloads\\Python\\Test\\Image samples\\Qr Alpha.png", use_column_width=True)
